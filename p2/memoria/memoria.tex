...
Hemos preparado los PCs con el servidor en \codigo{10.1.11.1} y el cliente en \codigo{10.1.11.2}. En las siguientes paginas están las imágenes que se piden de \texttt{free} y \texttt{nmon}.
...
NOTA: las mediciones han sido tomadas un viernes y un lunes por la tarde para intentar reducir el ruido en la red.

\pregunta[1]{¿Cómo debemos invocar a nmon para recolectar muestras cada 5 segundos durante 10 minutos que incluyan los top processes en el fichero log-file.nmon?}
nmon -F log-file.nmon -s 5 -t -c 120 

\ejercicio[9]{Cuestiones}

\pregunta[1]{A partir de la curva obtenida, determinar para cuántos usuarios conectados se produce el punto de 
...
\pregunta[2]{Analizando los valores de monitorización que se han ido obteniendo durante la elaboración de la
...
\pregunta[3]{Realizar el ajuste correspondiente en el servidor de aplicaciones, reiniciarlo y tomar una nueva
...
\begin{table}[h!]
	\centering
	\caption{Resultado de los cambios sobre P1-base}
	\TableAggregateCsv{../aggregate3.csv}
\end{table}
